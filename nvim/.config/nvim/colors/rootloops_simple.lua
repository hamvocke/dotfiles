...
if vim.o.background == 'light' then
  ...
  hi('Statement',    { fg = 'Cyan', bold = true,                  ctermfg = 'Cyan' })
  ...
  hi('CursorColumn', { bg = 'Black',                             ctermbg = 'DarkGrey' })
  hi('CursorLine',   { bg = 'Grey40',                             cterm = { underline = true } })
  hi('CursorLineNr', { fg = 'DarkGrey', bold = true,                ctermfg = 'Yellow', cterm = { underline = true } })
  ...
  hi('LineNr',       { fg = 'Grey',                             ctermfg = 'DarkGrey' })
  ...
  hi('WhichKeyDesc',    { fg = 'Magenta' })
  hi('WhichKeySeperator', { fg = 'Black' })
  hi('WhichKeySeparator', { fg = 'Black' })
  hi('WhichKeyNormal',  { bg = 'Black' })
  hi('WhichKeyValue',   { fg = 'White' })
end
--stylua: ignore end
